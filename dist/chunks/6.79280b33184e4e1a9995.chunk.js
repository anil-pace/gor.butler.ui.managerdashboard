...
/***/ function(module, exports, __webpack_require__) {
	...
	var _butlerbotTable = __webpack_require__(491);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ButlerBotTable = function (_React$Component) {
	  (0, _inherits3.default)(ButlerBotTable, _React$Component);

	  function ButlerBotTable(props) {
	    (0, _classCallCheck3.default)(this, ButlerBotTable);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (ButlerBotTable.__proto__ || (0, _getPrototypeOf2.default)(ButlerBotTable)).call(this, props));

	    var temp = new Array(_this.props.items.length).fill(false);
	    ...
	    var columnWidth = _this.props.containerWidth / _this.props.itemNumber;
	    _this.state = {
	  ...
	  (0, _createClass3.default)(ButlerBotTable, [{
	    ...
	    key: 'handlChange',
	    value: function handlChange(columnKey, rowIndex) {
	      console.log("checked");
	      console.log(columnKey);
	      console.log(rowIndex);
	    }
	    ...
	    value: function render() {
	      ...
	      var renderDropD = _state.renderDropD;
	      ...
	      if (this.state.renderDropD === true) {
	        drop = _react2.default.createElement(_dropdownTemp2.default, { items: item });
	      } else {
	        drop = _react2.default.createElement('div', null);
	      }
	      return _react2.default.createElement(
	        'div',
	        { className: 'gorTableMainContainer' },
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'butlerBot.table.heading',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_fixedDataTable.Column, {
	            ...
	            header: _react2.default.createElement(
	              ...
	              ' ',
	              _react2.default.createElement('input', { type: 'checkbox', onChange: this.handlChange }),
	              _react2.default.createElement(
	                'div',
	          ...
	          _react2.default.createElement(_fixedDataTable.Column, {
	            ...
	            header: _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'butlerBot.table.status',
	          ...
	          _react2.default.createElement(_fixedDataTable.Column, {
	            ...
	            header: _react2.default.createElement(
	              _commonFunctionsDataTable.SortHeaderCell,
	              null,
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'butlerBot.table.currentTask',
	                defaultMessage: 'CURRENT TASK' }),
	              _react2.default.createElement(
	                'div',
	                { className: 'gorToolHeaderSubText' },
	                ' 2 Pick, 1 Put, 2 charging, 1 Idle'
	              )
	            ),
	          ...
	          _react2.default.createElement(_fixedDataTable.Column, {
	            ...
	            header: _react2.default.createElement(
	              _commonFunctionsDataTable.SortHeaderCell,
	              null,
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'butlerBot.table.msu',
	                defaultMessage: 'MSU' }),
	              _react2.default.createElement(
	                'div',
	                { className: 'gorToolHeaderSubText' },
	          ...
	          _react2.default.createElement(_fixedDataTable.Column, {
	            ...
	            header: _react2.default.createElement(
	              _commonFunctionsDataTable.SortHeaderCell,
	              null,
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'butlerBot.table.location',
	          ...
	          _react2.default.createElement(_fixedDataTable.Column, {
	            ...
	            header: _react2.default.createElement(
	              _commonFunctionsDataTable.SortHeaderCell,
	              null,
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'butlerBot.table.direction',
