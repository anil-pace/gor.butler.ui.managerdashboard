	    ...
	    (0, _createClass3.default)(PickStatusWidget, [{
	        ...
	        value: function _parseProps() {
	            ...
	            if (!textleft) {
	                ...
	                textright = _react2.default.createElement(_reactIntl.FormattedRelative, { id: 'widget.pick.textright', description: 'Time remaining',
	                    value: new Date(remTime), units: 'hour|minute', style: 'numeric' });
