	        ...
	        value: function _parseProps() {
	            ...
	            if (!textleft) {
	                ...
	                if (!this.props.ordersData.count_risk) {
	                    ...
	                    statusleft = _react2.default.createElement(FormattedPlural, { id: 'widget.pick.statusRight', description: 'Heading for pick status widget',
	                        values: { count_risk: this.props.ordersData.count_risk }, one: '{count_risk} order at risk', other: '{count_risk} orders at risk' });
