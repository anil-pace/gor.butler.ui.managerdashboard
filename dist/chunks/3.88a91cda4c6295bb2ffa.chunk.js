	    ...
	    (0, _createClass3.default)(PickStatusWidget, [{
	        ...
	        value: function _parseProps() {
	            ...
	            if (!textleft) {
	                ...
	                remTime = _tomillisecs(this.props.ordersData.cut_off);

	                textright = _react2.default.createElement(FormattedTime, { id: 'widget.pick.textright', description: 'Time remaining',
	                    value: new Date(remTime) });
