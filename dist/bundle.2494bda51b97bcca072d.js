...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loginAction = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./actions/loginAction\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
		...
		(0, _createClass3.default)(Routes, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_reactRouter.Route, { name: 'login', path: '/login', onEnter: requireAuth,
						getComponent: function getComponent(location, callback) {
							__webpack_require__.e/* nsure */(2, function (require) {
								callback(null, __webpack_require__(466).default);
							});
						}
					}),
					_react2.default.createElement(
						...
						_react2.default.createElement(_reactRouter.IndexRoute, {
							getComponent: function getComponent(location, callback) {
								__webpack_require__.e/* nsure */(3, function (require) {
									callback(null, __webpack_require__(468).default);
								});
							}
						}),
