						...
						_react2.default.createElement(_reactRouter.Route, { name: 'system', path: '/system',
							getComponent: function getComponent(location, callback) {
								__webpack_require__.e/* nsure */(4, function (require) {
									callback(null, __webpack_require__(473).default);
								});
							}
						}),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toIObject = __webpack_require__(248)
	  , gOPN      = __webpack_require__(435).f
	  , toString  = {}.toString;
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(257)(Function.call, __webpack_require__(436).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
