...
/***/ function(module, exports, __webpack_require__) {
	...
	var FixedDataTable = __webpack_require__(495);
	var FixedDataTableCellDefault = __webpack_require__(532);
	var FixedDataTableColumn = __webpack_require__(530);
	var FixedDataTableColumnGroup = __webpack_require__(529);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(496);
	...
	// New Table API
	var Table = __webpack_require__(497);
	var Column = __webpack_require__(540);
	var ColumnGroup = __webpack_require__(541);

	// Transition Cell
	var TransitionCell = __webpack_require__(542);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(496);
	var ReactComponentWithPureRenderMixin = __webpack_require__(498);
	var ReactWheelHandler = __webpack_require__(499);
	var Scrollbar = __webpack_require__(507);
	var FixedDataTableBufferedRows = __webpack_require__(520);
	var FixedDataTableColumnResizeHandle = __webpack_require__(534);
	var FixedDataTableRow = __webpack_require__(525);
	var FixedDataTableScrollHelper = __webpack_require__(535);
	var FixedDataTableWidthHelper = __webpack_require__(537);

	var cx = __webpack_require__(514);
	var debounceCore = __webpack_require__(538);
	var emptyFunction = __webpack_require__(500);
	var invariant = __webpack_require__(519);
	var joinClasses = __webpack_require__(533);
	var shallowEqual = __webpack_require__(539);
	var translateDOMPositionXY = __webpack_require__(515);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var emptyFunction = __webpack_require__(500);
	var normalizeWheel = __webpack_require__(501);
	var requestAnimationFramePolyfill = __webpack_require__(505);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserAgent_DEPRECATED = __webpack_require__(502);

	var isEventSupported = __webpack_require__(503);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExecutionEnvironment = __webpack_require__(504);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var emptyFunction = __webpack_require__(500);
	var nativeRequestAnimationFrame = __webpack_require__(506);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMMouseMoveTracker = __webpack_require__(508);
	var Keys = __webpack_require__(511);
	var React = __webpack_require__(496);
	var ReactDOM = __webpack_require__(512);
	var ReactComponentWithPureRenderMixin = __webpack_require__(498);
	var ReactWheelHandler = __webpack_require__(499);

	var cssVar = __webpack_require__(513);
	var cx = __webpack_require__(514);
	var emptyFunction = __webpack_require__(500);
	var translateDOMPositionXY = __webpack_require__(515);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventListener = __webpack_require__(509);

	var cancelAnimationFramePolyfill = __webpack_require__(510);
	var requestAnimationFramePolyfill = __webpack_require__(505);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BrowserSupportCore = __webpack_require__(516);

	var getVendorPrefixedName = __webpack_require__(517);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(496);
	var FixedDataTableRowBuffer = __webpack_require__(521);
	var FixedDataTableRow = __webpack_require__(525);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IntegerBufferSet = __webpack_require__(522);

	var clamp = __webpack_require__(524);
	var invariant = __webpack_require__(519);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Heap = __webpack_require__(523);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(496);
	var FixedDataTableCellGroup = __webpack_require__(526);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FixedDataTableHelper = __webpack_require__(527);
	var React = __webpack_require__(496);
	var FixedDataTableCell = __webpack_require__(531);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Locale = __webpack_require__(528);
	var React = __webpack_require__(496);
	var FixedDataTableColumnGroup = __webpack_require__(529);
	var FixedDataTableColumn = __webpack_require__(530);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PrefixIntervalTree = __webpack_require__(536);
	var clamp = __webpack_require__(524);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CellDefault = __webpack_require__(532);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extends2 = __webpack_require__(492);

	var _extends3 = _interopRequireDefault(_extends2);

	var _objectWithoutProperties2 = __webpack_require__(545);
	...
	var _fixedDataTable = __webpack_require__(493);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _userTabTable = __webpack_require__(551);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extends3 = __webpack_require__(492);
	...
	var _dropdownTemp = __webpack_require__(543);
	...
	var _commonFunctionsDataTable = __webpack_require__(544);

	var _reactReduxModal = __webpack_require__(366);

	var _addNewUser = __webpack_require__(552);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_fixedDataTable.Column, {
	            ...
	            cell: _react2.default.createElement(_commonFunctionsDataTable.ComponentCell, { data: sortedDataList, checkState: checkState }),
	            width: columnWidth
	          }),
	          _react2.default.createElement(_fixedDataTable.Column, {
	            columnKey: 'status',
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'div',
	                  { className: 'gor-sub-head' },
	                  'A User ID will be required to log into the system'
	                ),
	                _react2.default.createElement(
	                  'div',
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'div',
	                  { className: 'gor-sub-head' },
	                  'User will be given a specific level of control over the Butler system depending on the designated role'
	                ),
	                _react2.default.createElement(
	                  'div',
	                  { className: 'gor-role' },
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    'div',
	                    { className: 'gor-sub-head' },
	                    'Grant access to the Operator Interface at each Pick Put Station in the Butler system'
	                  ),
	                  _react2.default.createElement(
	                    'span',
	                    { className: 'gor-usr-hdsm' },
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    'div',
	                    { className: 'gor-sub-head' },
	                    'Grant access to the Management Interface and Operator Interface for the Butler system'
	                  )
	                ),
	                _react2.default.createElement(
	                  'div',
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    'div',
	                    { className: 'gor-sub-head' },
	                    'Grant access to the Management Interface and Operator Interface to all systems'
	                  )
	                )
	              ),
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'div',
	                  { className: 'gor-sub-head' },
	                  'Min of 6 digits will be required for logging into the Operator Interface'
	                ),
	                _react2.default.createElement(
	                  'div',
	                  { className: 'gor-usr-hdsm' },
