        ...
        return (
            <div className="gorSnapShot">
                <table width="100%">
                    ...
                    <tr>
                        <th>
                            <FormattedMessage id='itemTable.categoryType.category' defaultMessage="Category"
                                              description="Category Name"/>
                        </th>
                        <th>
                            <FormattedMessage id='itemTable.cbmUsed.cbm' defaultMessage="CBM Used"
                                              description="CBM Used field"/>
                        </th>
                        <th>
                            <FormattedMessage id='itemTable.daysInHand.count' defaultMessage="Days in Hand"
