...
import sysOverview from '../containers/systemTabs/sysOverview'
import App from '../App'
  ...
  render() {
    return (
      <Router history={hashHistory}>
        <Route
          onEnter={this._handleNavigationChanges.bind(this)}
          name='default'
          path='/'
        ...
        <Route
          name='login'
          path='/login'
          onEnter={this._refreshPage.bind(this)}
          getComponent={(location, callback) => {
            require.ensure(
              [],
              function(require) {
        ...
        >
          ...
          <Route
            ...
            name='system'
            path='/system'
            className='gorResponsive'
            component={systemTab}
          >
            <IndexRoute component={sysOverview} />
            <Route
              onEnter={this._handleNavigationChanges.bind(this)}
              name='sysOverview'
              path='/system/sysOverview'
              component={sysOverview}
            />
            <Route
              onEnter={this._handleNavigationChanges.bind(this)}
              name='butlerbots'
              path='/system/butlerbots'
            ...
            <Route
              ...
              path='/system/chargingstation'
              component={chargingStationsTab}
            />
            <Route
              onEnter={this._handleNavigationChanges.bind(this)}
              name='sysControllers'
              path='/system/sysControllers'
              component={sysControllers}
            />

            <Route
              onEnter={this._handleNavigationChanges.bind(this)}
              name='ppsConfiguration'
              path='/system/ppsConfiguration'
              component={ppsConfigurationTab}
            />

            <Route
              onEnter={this._handleNavigationChanges.bind(this)}
              name='msuConfiguration'
              path='/system/msuConfiguration'
          ...
          >
            <IndexRoute component={auditListing} />
            <Route
              onEnter={this._handleNavigationChanges.bind(this)}
              name='auditlisting'
              path='/audit/auditlisting'
              component={auditListing}
            />
            <Route
              onEnter={this._handleNavigationChanges.bind(this)}
              name='itemsearch'
              path='/audit/itemsearch'
          ...
          >
            <IndexRoute component={operationsLogTab} />

            <Route
              onEnter={this._handleNavigationChanges.bind(this)}
              name='operationsLog'
              path='/reports/operationsLog'
