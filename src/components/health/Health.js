	...
	render(){	
		...
		<div className="block">
			...
			<div className="block paramPositionMiddle ">
					...
					<div className="status"><FormattedMessage id="healthTab.status.on" description="on status for healthtab" defaultMessage="Open"/> </div>
				</div>
				<div className="block paramPositionMiddle ">
					<div className="block offState" >
						<span>{this.props.items[0].states.offState}</span>
					</div>
					<div className="status"><FormattedMessage id="healthTab.status.off" description="off status for healthtab" defaultMessage="Close"/></div>
				</div>
