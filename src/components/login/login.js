    ...
    return (
      <div>
        ...
        <div className="gor-login-form">
          <Spinner
            isLoading={this.props.loginSpinner}
            setSpinner={this.props.setLoginSpinner}
          />
          <div className="gor-login-lang">
            ...
            <Dropdown
              optionDispatch={e => this._handleSelectionChange(e)}
          ...
          <div className="gor-box-bottom">
            <span className="gor-box-bottom-left" />
            <span className="gor-box-bottom-right" />
          </div>
          <Footer />
        </div>
      </div>
...
var mapDispatchToProps = function(dispatch) {
  return {
    ...
    setLoginSpinner: function(params) {
      dispatch(setLoginSpinner(params));
    }
  };
};
