    ...
    return (
      ...
      >
        <div className='gor-login-mid'>
          ...
          {this.props.loginInfo.type === ERROR && (
          ...
          <section>
            <div
              className={
                'gor-login-field' +
                (this.props.userNameCheck.type === ERROR ||
                this.props.loginInfo.type === ERROR
                  ? ' gor-input-error'
                  : ' gor-input-ok')
              }
            ...
            >
              <div
                className={
                  this.props.userNameCheck.type === ERROR ||
                  this.props.loginInfo.type === ERROR
                    ? 'gor-login-user-error'
                    : 'gor-login-user'
                }
              />
              <input
                className='field'
                onInput={this._typing.bind(this, 1)}
                onBlur={this._checkUser.bind(this)}
                type='text'
                id='username'
          ...
          <section>
            ...
            >
              ...
              <input
                className='field'
                onInput={this._typing.bind(this, 2)}
                onBlur={this._checkPass.bind(this)}
                type='password'
                id='password'
          ...
          <section>
            <input
              type='submit'
              className='gor-login-btn'
              value={this.props.intlMessages['login.form.button']}
            />
            <br />
          </section>
        </div>
