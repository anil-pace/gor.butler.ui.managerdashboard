								...
								>
									{!validationDoneSKU && (
										<div className="gor-audit-inputlist-wrap">
											...
											<div>
												{self.state.copyPasteSKU.data.map(
													function(tuple, i) {
														let focus =
															self.state
																.copyPasteSKU
							...
							{!allSKUsValid && (
								<div
									className={
										...
										(this.props.skuValidationSpinner
											? " gor-disable-content"
											: "")
									}
								>
							...
							<div>
								<button
									...
									className={
										validationDoneSKU &&
										allSKUsValid &&
										self.state.skuAttributes.totalSKUs !== 0
...
export default connect(null, mapDispatchToProps)(SkuSelector);
