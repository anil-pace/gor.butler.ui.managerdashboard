...
class FilterInputFieldWrap extends React.Component{
 ...
 _processInputField() {
  ...
  for (let i=0; i < length; i++) {
   ...
   var inputField=<FilterInputField key={i} by2value={by2value} placeholder={this.props.placeholder} type={type} inputText={totalInput[i]} handleInputText={this.props.handleInputText} inputValue={inputValue} flag={flag}/>;
