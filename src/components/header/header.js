...
class Header extends React.Component {
  ...
  _handleDocumentClick() {
    if (
      !(
        ReactDOM.findDOMNode(this.dropdownNode).contains(event.target) ||
        (this.dropdownValue &&
          ReactDOM.findDOMNode(this.dropdownValue).contains(event.target))
      )
    ) {
  ...
  _processData() {
    ...
    if (this.props.headerInfo && this.props.headerInfo.users.length) {
      ...
      headerInfo.fullName =
        (headerInfo.users[0].first_name || '') +
        ' ' +
        (headerInfo.users[0].last_name || '');
    ...
    if (this.props.breached) {
      emergencyDropDown = (
        <section className='gor-hamburger-option'>
          <h1>
            {this.props.zoneHeader.active_zones ? (
              <FormattedMessage
        ...
        <section className='gor-hamburger-option'>
          ...
          <p>
            <FormattedMessage
              ...
              values={{
                activeZones:
                  this.props.zoneHeader.active_zones === 0
                    ? this.props.zoneHeader.active_zones.toString()
                    : this.props.zoneHeader.active_zones,
                totalZones:
                  this.props.zoneHeader.total_zones === 0
                    ? this.props.zoneHeader.total_zones.toString()
                    : this.props.zoneHeader.total_zones
              }}
            />
          </p>
      ...
      this.props.system_data === SOFT_MANUAL
    ) {
      emergencyDropDown = (
        <section className='gor-hamburger-option'>
          <h1>
        ...
        <div className='mainBlock'>
          ...
          <div className='blockSystem'>
            ...
            <div className={'gor-menu-subheading '}>
              <FormattedMessage
                id='header.currentWarehouse'
                description='Current Warehouse Time '
          ...
          <HamBurger>
            {instance => (
              <div>
                ...
                <div
                  className='gor-hamburger-wrapper'
                  style={
                    instance.state.menuVisible
                      ? { display: 'block' }
                      : { display: 'none' }
                  }
                >
