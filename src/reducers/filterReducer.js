import {SHOW_FILTER, IS_FILTER_APPLIED,BUTLER_FILTER_STATE,CHARGINGSTATION_FILTER_STATE,PPS_FILTER_STATE,
  ...
  USER_TOGGLE_FILTER,WAVES_TOGGLE_FILTER,FILTER_APPLY_FLAG, MSU_FILTER_STATE} from '../constants/frontEndConstants'; 
/**
 * @param  {State Object}
 * @param  {Action object}
...
case ORDER_FILTER_VALUE:               //This reducer will update the the ppsFilterState value with latest applied filter
    ...
    case MSU_FILTER_STATE:          //This reducer will update the the butlerFilterState value with latest applied filter
    return Object.assign({}, state, { 
      "msuFilterState" : action.data
    })
