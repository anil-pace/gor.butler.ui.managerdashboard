  ...
  switch (action.type) {
    case THROUGHPUT_DATA:
          ...
          if(res.aggregate_data){
              put_throughput=res.aggregate_data.put_throughput ? Number(res.aggregate_data.put_throughput) : 0;
              pick_throughput=res.aggregate_data.pick_throughput ? Number(res.aggregate_data.pick_throughput) : 0;
              audit_throughput= res.aggregate_data.audit_throughput ? Number(res.aggregate_data.audit_throughput) : 0;
          }
          throughput_data={
