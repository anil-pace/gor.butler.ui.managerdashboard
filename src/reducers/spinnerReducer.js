...
DISPLAY_PPS_FILTER_SPINNER,DISPLAY_BOT_FILTER_SPINNER,DISPLAY_WAVES_FILTER_SPINNER,DISPLAY_CHARGING_STATION_FILTER_SPINNER,DISPLAY_INVENTORY_REPORT_SPINNER,GENERATE_REPORT_SPINNER} from '../constants/frontEndConstants'
...
case DISPAY_USER_SPINNER:
      ...
      return Object.assign({}, state, {
		...
		case GENERATE_REPORT_SPINNER:
      return Object.assign({}, state, {
	    	"generateReportSpinner":action.data
	  })
