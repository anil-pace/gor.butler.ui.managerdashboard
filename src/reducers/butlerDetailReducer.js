    ...
    if (data[i].current_task !== null) {
      ...
      if (data[i].current_subtask !== null) {
        butlerDetail.current =
          butlerDetail.current +
          ' - ' +
          currentSubtask[data[i].current_subtask];
        if (data[i].charger_id !== null) {
          butlerDetail.current =
            butlerDetail.current + ' CS ' + data[i].charger_id;
        } else if (data[i].msu_id !== null) {
          butlerDetail.current =
            butlerDetail.current + ' MSU ' + data[i].msu_id;
        } else {
          butlerDetail.current =
            butlerDetail.current + ' PPS ' + data[i].pps_id;
        }
      }
    } else {
      butlerDetail.current = '--';
