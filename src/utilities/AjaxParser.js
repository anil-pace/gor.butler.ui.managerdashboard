...
import {US001,US002,US004,UE001,UE002,UE003,UE004,UE005,UE006,E028,E029,MODE_REQUESTED,TYPE_SUCCESS,E025,G015,AS001} from '../constants/messageConstants'; 
		...
		case CREATE_AUDIT:
		    ...
		    {	
		    	switch(res.alert_data[0].code)
		    	{
					...
					default:
		    			store.dispatch(notifyFail('Error in creating audit'));		    				    									    				    				    		
		    	}
		   	}
		   	else
		   	{
