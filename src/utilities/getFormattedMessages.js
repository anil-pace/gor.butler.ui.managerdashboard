...
export function getFormattedMessages(action, values) {
  ...
  switch (action) {
    ...
    case 'BulkAudit':
      return (
        <FormattedMessage
          id='utility.bulkaudit.successMessage'
          description='Bulk Audit successMessage'
          defaultMessage='{successful}/{totalCount} audits started successfully'
          values={values}
        />
      );
    case 'status':
    ...
    case 'SETORDERPRIORITYSUCCESS':
      return (
        <FormattedMessage
          id='order.setpriority.generateSuccess'
          description='set order priority successfully'
          defaultMessage='Change of Order Priority has been triggered'
        />
      );
    ...
    case 'SETORDERPRIORITYFAILURE':
      return (
        <FormattedMessage
          id='order.setpriority.generateFailure'
          description='set order priority UNsuccessfully'
          defaultMessage='Order Priority has not been changed'
          values={values}
        />
      );
    ...
    case 'DELETEAUDIT':
      return (
        <FormattedMessage
          id='audit.delete.success'
          description='Audit deletion success'
          defaultMessage='Audit {id} has been deleted'
          values={values}
        />
      );
      break;
    ...
    case 'DELETEAUDITFAIL':
      return (
        <FormattedMessage
          id='audit.delete.reject'
          description='Audit deletion'
          defaultMessage='Audit {id} failed to delete'
          values={values}
        />
      );
      break;
    ...
    case 'CREATEAUDIT':
      return (
        <FormattedMessage
          id='audit.create.success'
          description='Audit Creation success'
          defaultMessage='Audit {id} created successfully'
          values={values}
        />
      );
      break;
    ...
    case 'PAUSEAUDIT':
      return (
        <FormattedMessage
          id='audit.pause.success'
          description='Audit paused success'
          defaultMessage='Audit {id} has been paused'
          values={values}
        />
      );
      break;
    ...
    case 'EDITED':
      return (
        <FormattedMessage
          id='audit.edit.success'
          description='Audit edited success'
          defaultMessage='Audit {id} updated successfully'
          values={values}
        />
      );
      break;
    ...
    case 'DUPLICATED':
      return (
        <FormattedMessage
          id='audit.duplicate.success'
          description='Audit duplicate success'
          defaultMessage='Audit {id} successfully duplicated'
          values={values}
        />
      );
      break;
    ...
    case 'CANCELLED':
      return (
        <FormattedMessage
          id='audit.cancelsent.status'
          description='Audit cancel sent status'
          defaultMessage='Audit {id} sent for cancellation'
          values={values}
        />
      );
      break;
    ...
    case 'STARTFAIL':
      ...
      startFailstringInfo = {
        ...
        msg: (
          <FormattedMessage
            id='audit.start.fail'
            description='audit start fail'
            defaultMessage='AUDIT NOT STARTED'
          />
        ),
        desc: (
          <FormattedMessage
            id='audit.start.fail_desc'
            description='audit start fail description'
            defaultMessage='{fail} audit failed due to location/sku of audit currently in process'
            values={{ fail: values.fail }}
          />
        )
      };
    ...
    case 'STARTFAILALL':
      let startFailAllstringInfo = {
        ...
        msg: (
          <FormattedMessage
            id='audit.start.failall'
            description='audit start failall'
            defaultMessage='AUDIT NOT STARTED'
          />
        ),
        desc: (
          <FormattedMessage
            id='audit.start.failall_desc'
            description='audit start fail all description'
    ...
    case 'RESOLVEFAIL':
      let resolveFailstringInfo = {
        ...
        msg: (
          <FormattedMessage
            id='audit.resolve.fail'
            description='audit resolve fail'
            defaultMessage='AUDIT RESOLVE FAIL'
          />
        ),
        desc: (
          <FormattedMessage
            id='audit.resolve.fail_desc'
            description='audit resolve fail all description'
    ...
    case 'EDITEDUSER':
      return (
        <FormattedMessage
          id='notify.successfully.edit'
          description='Text for successfull user edit'
    ...
    case 'DELETEDUSERFAIL':
      let deleteFailString = {
        ...
        msg: (
          <FormattedMessage
            id='notify.fail.delete'
            description='Text for fail user deletion'
    ...
    case 'NEWUSERFAIL':
      let addFailString = {
        ...
        msg: (
          <FormattedMessage
            id='notify.fail.add'
            description='Text for fail user add'
