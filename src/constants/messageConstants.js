...
export const CANCEL_SUCCESS = (<FormattedMessage id="audit.cancellation.success" description='Audit Id cancellation is successful'
                                   defaultMessage='Request sent for audit cancellation'/>);
