...
export const DUTCH = (
  <FormattedMessage
    ...
    description="Dutch option in the language drop down"
  />
)
...
export const HISTOGRAM_NO_DATA_TEXT = (
  <FormattedMessage
...
export const G025 = (
  <FormattedMessage
    id="audit.cancellation.error.g025"
    description="Audit cancellation failed because of audit status"
    defaultMessage="Audit cancellation failed because of audit status"
  />
)
export const G027 = (
  <FormattedMessage
    id="audit.cancellation.error.g027"
    description="Audit cancellation failed"
    defaultMessage="Audit cancellation failed"
  />
)
...
export const ppsModeFailure =
  "{unsuccessful}/{totalCount} mode change requests rejected"
export const ppsStatusFailure =
...
export const REQUEST_REPORT_SUCCESS = (
  <FormattedMessage
    id="operationsLog.reportRequest.success"
    description="Status text for zone"
    defaultMessage="Request successfully generated. Kindly check the Download Tab"
  />
)
export const REQUEST_REPORT_FAILURE = (
  <FormattedMessage
    id="operationsLog.reportRequest.failure"
    description="Status text for zone"
    defaultMessage="Error creating request"
  />
)
export const INCORRECT_STN_NUMBER = (
  <FormattedMessage
    id="miscReports.stnNumRequest.failure"
    description="Incorrect STN Number"
...
export const ZONE_SUB_STATUS_INTL_MESSAGE = {
  zone_pause: (
    <FormattedMessage
      id="zoning.substatus.action.zone_pause"
      description="Status text for zone"
      defaultMessage="Zone pause activated"
    />
  ),
  zone_clear: (
    <FormattedMessage
      id="zoning.substatus.action.zone_clear"
      description="Status text for zone"
      defaultMessage="Zone clear activated"
    />
  ),
  emergency_stop: (
    <FormattedMessage
      id="zoning.substatus.action.emergency_stop"
      description="Status text for zone"
      defaultMessage="System stop activated"
    />
  ),
  emergency_pause: (
    <FormattedMessage
      id="zoning.substatus.action.emergency_pause"
      description="Status text for zone"
      defaultMessage="System pause activated"
    />
  )
...
export const ENTITY_BREACHED = {
  light_curtain: (
    <FormattedMessage
      id="zoning.entity.lightCurtains"
      description="Status text for zone"
...
export const ITEM_RECALL_SUCCESS = (
  <FormattedMessage
    id="itemRecall.message.success"
    description="Status text for zone"
...
export const ITEM_RECALL_FAILURE = {
  DUPLICATE_KEY: (
    <FormattedMessage
      id="itemRecall.message.failure.duplicate_key"
      description="Message for duplicate order id"
      defaultMessage="Order id already exists"
    />
  ),
  NO_ITEM_EXIST: (
    <FormattedMessage
      id="itemRecall.message.failure.no_item"
      description="Message for duplicate order id"
