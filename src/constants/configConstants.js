...
export const AUDIT_VALIDATION_URL="https://192.168.14.124:5000/api/audit/validate";
export const AUDIT_CREATION_URL="https://192.168.14.124:5000/api/audit/";//TIME_ZONE_URL;//API_URL + "api/audit/validate";
