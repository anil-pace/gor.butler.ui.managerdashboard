export const BASE_URL = '192.168.9.218';
...
export const ORDERS_FULFIL_URL =
  "https://45.118.135.148/api-gateway" + '/sr-service/platform-srms/md/order-fulfilment';
export const ORDERS_SUMMARY_URL =
  "https://45.118.135.148/api-gateway" + '/sr-service/platform-srms/md/order-summary';
export const ORDERS_CUT_OFF_TIME_URL =
  "https://45.118.135.148/api-gateway" + '/sr-service/platform-srms/md/order-details/level1';
export const ORDERS_PER_PBT_URL =
  "http://45.118.135.148/api-gateway" + '/sr-service/platform-srms/md/order-details/level2';
export const ORDERLINES_PER_ORDER_URL =
  "http://45.118.135.148/api-gateway" + '/sr-service/platform-srms/md/order-details/level3';
