...
export const stringConfig = defineMessages({
  ...
  sodimac_packing_operator: {
    id: 'stringConfig.sodimac_packing_operator',
    description: 'Text to show sodimac_packing_operator',
    defaultMessage: 'Operator Packing'
  },
  sodimac_rollcage_operator: {
    id: 'stringConfig.sodimac_rollcage_operator',
    description: 'Text to show sodimac_rollcage_operator',
  ...
  md013: {
    ...
    defaultMessage:
      'Move bots to the PPS location and do an "init" after all bots are moved.'
  },
  md014: {
