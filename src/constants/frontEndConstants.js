...
export const PENDING =
  "audit_accepted__audit_pending__audit_waiting__audit_conflicting"
...
export const DOWNLOAD_STOCK_LEDGER_RAW_TRANSACTIONS_REPORT =
...
export const CLEAR_STOCK_LEDGER_SKU_VALIDATION =
...
export const DISPLAY_CHARGING_STATION_SPINNER =
...
export const DISPLAY_CHARGING_STATION_FILTER_SPINNER =
  "DISPLAY_CHARGING_STATION_FILTER_SPINNER"
export const DISPLAY_INVENTORY_REPORT_SPINNER =
  "DISPLAY_INVENTORY_REPORT_SPINNER"
export const DISPLAY_STOCK_LEDGER_SPINNER = "DISPLAY_STOCK_LEDGER_SPINNER"
export const DISPLAY_STOCK_LEDGER_RAW_TRANSACTIONS_SPINNER =
  "DISPLAY_STOCK_LEDGER_RAW_TRANSACTIONS_SPINNER"
export const FIRE_EMERGENCY_POPUP_FLAG = "FIRE_EMERGENCY_POPUP"
export const DISPLAY_PPS_CONFIGURATION_SPINNER =
  "DISPLAY_PPS_CONFIGURATION_SPINNER"
export const DISPLAY_MSU_CONFIG_SPINNER = "DISPLAY_MSU_CONFIG_SPINNER"
export const DISPLAY_MSU_CONFIG_FILTER_SPINNER =
...
export const LESS_THAN_EXPECTED = "less_than_expected"
export const MORE_THAN_EXPECTED = "more_than_expected"
...
export const VALIDATED_ATTIBUTES_DATA_LOCATION =
  "VALIDATED_ATTIBUTES_DATA_LOCATION"
export const VALIDATED_ATTIBUTES_DATA_SKU = "VALIDATED_ATTIBUTES_DATA_SKU"
export const VALIDATED_ATTIBUTES_DATA_SKU_CSV =
  "VALIDATED_ATTIBUTES_DATA_SKU_CSV"
export const VALIDATED_ATTIBUTES_DATA_LOCATION_CSV =
...
export const sortAuditHead = {
  ...
  status:
    "&order_by=audit_status&order_by_seq=[ 'audit_pending_approval','audit_created','audit_accepted','audit_conflicting','audit_waiting','audit_resolved','audit_pending','audit_reaudited','audit_started','audit_tasked','audit_rejected','audit_resolved','audit_aborted', 'audit_completed']"
}
...
export const sortOrderHead = {
  ...
  id: "&sort=id",
  status:
    "&sort=state&order_by_seq=['breached','exception','not_fulfillable','abandoned','temporary_unfulfillable','pending','fulfillable','cancelled','completed']"
}
...
export const PPS_MODE_EXTRACTION = "extraction"
...
export const SELECT_PPS_PROFILE_FOR_CONFIGURATION =
...
export const ORDER_PRIORITY = "ORDER_PRIORITY"
