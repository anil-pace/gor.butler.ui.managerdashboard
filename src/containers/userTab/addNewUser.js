        ...
        <div>
          <div className="modal-content">
            ...
            <div className='gor-sub-head'>User will be given a specific level of control over the Butler system depending on the designated role</div>
                ...
                <input type="radio" value="operator" checked name="role" ref={node => { this.operator = node }} /><span className='gor-usr-hdsm'> Operator</span>
                </div>
                <div className='gor-choose'>
                  ...
                  <span className='gor-usr-hdsm'><input type="checkbox" value="pick" checked name='access' ref={node => { this.pick = node }} /> Pick Operator</span>
                  <span className='gor-usr-hdsm'><input type="checkbox" value="put" name='access'  ref={node => { this.put = node }} /> Put Operator</span>
                  <span className='gor-usr-hdsm'><input type="checkbox" value="audit" name='access'  ref={node => { this.audit = node }} /> Audit</span>            
                </div>

                <div className='gor-role'>
                <input type="radio" value="supervisor"  name="role" ref={node => { this.supervisor = node }} /><span className='gor-usr-hdsm'> Supervisor</span>
                </div>
                <div className='gor-choose'>
                ...
                <div className='gor-role'>
                <input type="radio" value="manager"  name="role" ref={node => { this.manager = node }} /><span className='gor-usr-hdsm'> Manager</span>
                </div>
                <div className='gor-choose'>
