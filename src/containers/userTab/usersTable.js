...
class UsersTable extends React.Component {
  ...
  _onSortChange(header) {
    ...
    let updated_list = this.state.userList.sort(function(a, b) {
      if (a[header.key].toLowerCase() < b[header.key].toLowerCase())
        return header.sortDir === 'asc' ? -1 : 1;
      if (a[header.key].toLowerCase() > b[header.key].toLowerCase())
        return header.sortDir === 'asc' ? 1 : -1;
      return 0;
    });
    ...
    return (
      <div className='users-table'>
        <GTable>
          <GTableHeader>
            <GTableHeaderCell
              header={self.state.header[0]}
              onClick={self._onSortChange.bind(self, this.state.header[0])}
            >
              <span>
                <FormattedMessage
                  ...
                  values={{ rowsCount: this.state.userList.length }}
                />{' '}
                {}
              </span>
            </GTableHeaderCell>
            <GTableHeaderCell
              header={self.state.header[1]}
              onClick={self._onSortChange.bind(self, this.state.header[1])}
            >
              <span>
                <FormattedMessage
            ...
            <GTableHeaderCell
              header={self.state.header[2]}
              onClick={self._onSortChange.bind(self, this.state.header[2])}
            >
              <span>
                <FormattedMessage
                  id='user.table.role'
            ...
            <GTableHeaderCell
              header={self.state.header[3]}
              onClick={self._onSortChange.bind(self, this.state.header[3])}
            >
              <span>
                <FormattedMessage
            ...
            <GTableHeaderCell
              header={self.state.header[4]}
              onClick={self._onSortChange.bind(self, this.state.header[4])}
            >
              <span>
                <FormattedMessage
            ...
            <GTableHeaderCell
              header={self.state.header[5]}
              onClick={self._onSortChange.bind(self, this.state.header[5])}
            >
              <span>
                <FormattedMessage
          ...
          <GTableBody data={self.state.userList}>
            {self.state.userList &&
              self.state.userList.map(function(row, idx) {
                return (
                  <GTableRow key={idx} index={idx} data={self.state.userList}>
                    <div
                      style={
                        self.state.header[0].width
                    ...
                    <div
                      style={
                        self.state.header[1].width
                          ? { flex: '1 0 ' + self.state.header[1].width + '%' }
                          : {}
                      }
                      className='cell'
                    >
                    ...
                    <div
                      style={
                        self.state.header[2].width
                          ? { flex: '1 0 ' + self.state.header[2].width + '%' }
                          : {}
                      }
                    ...
                    <div
                      style={
                        self.state.header[3].width
                          ? { flex: '1 0 ' + self.state.header[3].width + '%' }
                          : {}
                      }
                      className='cell'
                    >
                    ...
                    <div
                      style={
                        self.state.header[5].width
                          ? { flex: '1 0 ' + self.state.header[5].width + '%' }
                          : {}
                      }
                      className='cell'
                    >
