      ...
      mutate({
        ...
        update: (proxy, { data: { deleteUser } }) => {
          ...
          if (deleteUser.firstname && deleteUser.lastname) {
            ...
            msg = getFormattedMessages('DELETEDUSERFAIL', deleteUser);
      ...
      <div>
        <div className='gor-delete gor-modal-content'>
          <div className='gor-delete-text'>
            <div className='gor-question' />
            <div className='gor-delete-line'>
              <div className='gor-delete-query'>
                <FormattedMessage
                  ...
                  values={{ user_name: this.props.name ? this.props.name : '' }}
                />
          ...
          <div className='gor-delete-bottom'>
            ...
            <button
              className='gor-delete-btn'
              onClick={this.userDelete.bind(this)}
            >
              <FormattedMessage
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(compose(withMutations)(DeleteUser));
