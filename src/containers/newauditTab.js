...
class NewAuditTab extends React.Component {
    constructor(props) {
        super(props);
...
render() {
    console.log("==========================> coming inside NewAuditTab component");
...
NewAuditTab.contextTypes={
    intl: React.PropTypes.object.isRequired
}
NewAuditTab.PropTypes={
...
export  default connect(mapStateToProps, mapDispatchToProps)(NewAuditTab);
