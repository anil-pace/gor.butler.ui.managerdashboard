...
import { SET_ORDER_PRIORITY_URL } from '../../constants/configConstants';
    ...
    var data = [
      {
        ...
        text: (
          <FormattedMessage
            ...
            description='label text for high'
            defaultMessage='High'
          />
        )
      },
      {
        ...
        text: (
          <FormattedMessage
            ...
            description='label text for normal'
      ...
      },
      {
        ...
        text: (
          <FormattedMessage
            ...
            description='label text for low'
            defaultMessage='Low'
          />
        )
      },
      {
        ...
        text: (
          <FormattedMessage
            ...
            description='label text for critical'
        ...
        <div ref={this.setWrapperRef}>
          <div className='orderPriorityWrapper'>
            <div className='orderPriorityListWrapper'>
              ...
              <ul className='orderPriorityList'>{arr}</ul>
              <div
                className={this.state.applyButtonClassName}
                onClick={() =>
                  this._applyOrderPriority(this.props.orderExternalId)
                }
              >
                <FormattedMessage
