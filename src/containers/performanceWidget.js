...
function _getButlerdata(link) {
  ...
  if (link.butlersData) {
    if (
      link.butlersData.active !== undefined &&
      link.butlersData.inactive !== null
    ) {
...
function _getChargingdata(link) {
  ...
  if (link.chargersData) {
    if (
      link.chargersData.Connected !== undefined &&
      link.chargersData.Connected !== null
    ) {
      connected = link.chargersData.Connected
    }

    if (
      link.chargersData.Disconnected !== undefined &&
      link.chargersData.Disconnected !== null
    ) {
