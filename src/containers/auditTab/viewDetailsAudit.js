                               ...
                               <GTableRow key={idx} index={idx} offset={tableData.offset} max={tableData.max} data={tableData} >
                                   ...
                                   {Object.keys(row).map(function (text, index) {
                                       return <div key={index} style={tableData[index].width?{flex:'1 0 '+tableData[index].width+"%"}:{}} className="cell" >  
                                          {index==0?<DotSeparatorContent header={['8876GHT54']} subHeader={['iPhone 8 Plus special...']} separator={'.'} />:""} 
                                          {index==1?<DotSeparatorContent header={['3 Attributes selected']} subHeader={['Red','128gb','Special Edition']} separator={'.'} />:""}     
