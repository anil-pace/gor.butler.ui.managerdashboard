...
import {
  GOR_BREACHED_LINES, APPROVE_AUDIT,
  GOR_USER_TABLE_HEADER_HEIGHT, GOR_AUDIT_RESOLVE_MIN_HEIGHT, GOR_AUDIT_RESOLVE_WIDTH,
  AUDIT_RESOLVE_CONFIRMED, AUDIT_BY_SKU, GOR_AUDIT_STATUS_DATA
  ...
  _renderPDFAtable(data) {
    ...
    var pdfaHeader = <Table
      ...
      <Column header={<div className="gorAuditHeader">
        <FormattedMessage id="resolveAudit.table.slotID" description="slot id Column" defaultMessage="SLOT ID" />
      </div>} width={220} />
      <Column header={<div className="gorAuditHeader">
