...
class PPS extends React.Component {
    ...
    _refreshList(query) {
        ...
        if (query.operator) {
            ...
            filterSubsData["operators_assigned"]=operator_assigned_query.length>1?["contains",operator_assigned_query]:["contains_partial",operator_assigned_query.join("").trim()];
        }
