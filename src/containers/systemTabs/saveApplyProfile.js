...
class SaveApplyProfile extends React.Component {
    ...
    saveAndApplyProfile(pps_id, profile_name) {
        let self = this
        this.props.saveAndApplyProfile(true).then(function () {
            ...
            <div className='gor-create-profile'>
                <div className='gor-create-profile-header'>
                    ...
                    <div><span><FormattedMessage id="pps.configuration.confirm.saveAndapply.profile"
                        ...
                        <span className="gor-create-profile-header-description"><span><FormattedMessage
                            id="pps.configuration.confirm.saveAndapply.profile.description"
                            description="Profile will be applied after pending tasks are completed"
                            defaultMessage="Profile will be applied after pending tasks are completed"/></span></span>
                    </div>
                ...
                <div className='gor-create-profile-action-button'>
                    ...
                    <button onClick={this.saveAndApplyProfile.bind(this, this.props.pps_id, this.props.profile_name)}
...
export  default (SaveApplyProfile);