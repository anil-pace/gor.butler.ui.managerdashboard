        ...
        return (
            <div className="pps-configuration-container">
                ...
                {this.props.selectedPPS && <div className="pps-configuration-actions-container">
                    ...
                    {this.state.currentView==="groups" && <button disabled={self.props.selectedPPS.pps_profiles.filter(function(profile){ return profile.requested}).length>0 || self.props.selectedPPS.pps_status===PPS_STATUS_FCLOSE || self.props.selectedPPS.requested_status===PPS_STATUS_FCLOSE} onClick={self.saveAndApplyProfileConfirmation.bind(self)} className="pps-bin-save-apply-button"><FormattedMessage id="pps.configuration.buttons.saveApply.text"
