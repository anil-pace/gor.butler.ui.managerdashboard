              ...
              {butlerData ? (
                <div>
                  <div>
                    ...
                    >
                      <ButlerBotFilter
                        noResults={butlerData.length === 0}
                        filterState={this.props.botsFilterStatus}
                        isFilterApplied={this.props.isFilterApplied}
                        showBotsFilter={this.showBotsFilter}
                        butlerfilterState={this.props.butlerfilterState}
...
const withClientData = graphql(botsClientData, {
  props: data => ({
    ...
    isFilterApplied: data.data.botsFilter
      ? data.data.botsFilter.isFilterApplied
      : false,
    botsFilterStatus: data.data.botsFilter
