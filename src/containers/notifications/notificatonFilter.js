...
class NotificatonFilter extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
     ...
     */
    if (
      nextProps.auditDetail.length > 0 &&
    ...
    const filterInputFields = [
      {
        ...
        label: (
          <FormattedMessage
            id='audit.inputField.notification'
  ...
  _processFilterToken() {
    ...
    const labelC2 = [
      ...
      },
      {
        value: 'ORDER',
        label: (
          <FormattedMessage id='audit.token2.order' defaultMessage='Order' />
        )
      },
      {
        value: 'SYSTEM',
