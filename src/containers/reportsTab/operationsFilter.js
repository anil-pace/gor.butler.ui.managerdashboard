...
class OperationsFilter extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
         ...
         */
        if (nextProps.data.length > 0 && this.props.refreshedAt !== nextProps.refreshedAt) {
    ...
    _processFilterToken(filterParams) {
        ...
        let statusColumn = <FilterTokenWrap field={filterParams.statusToken}
                                            tokenCallBack={this._handelTokenClick.bind(this)}
                                            label={filterParams.statusLabels} selectedToken={selectedToken}/>;
        let timePeriodColumn = <FilterTokenWrap selection={SINGLE} field={filterParams.timePeriodToken}
                                                tokenCallBack={this._handelTokenClick.bind(this)}
                                                label={filterParams.timePeriodLabels} selectedToken={selectedToken}/>;
        let operatingModeColumn = <FilterTokenWrap field={filterParams.operatingModeToken}
                                                   tokenCallBack={this._handelTokenClick.bind(this)}
    ...
    _applyFilter() {
        ...
        if (filterState.searchQuery) {
            ...
            if (filterState.tokenSelected["timeperiod"] && filterState.tokenSelected["timeperiod"][0] !== "realtime") {
        ...
        return (
            <div>
                <Filter>
                    ...
                    <span className="gor-filter-footer-h2" onClick={this.props.refreshList}>
                        ...
                        <div className="gor-filter-btn-wrap">
                            <button className='gor-add-btn' onClick={this._applyFilter}>
                                {!this.props.responseFlag ?
                                    <FormattedMessage id="gor.filter.heading" description="filter heading"
