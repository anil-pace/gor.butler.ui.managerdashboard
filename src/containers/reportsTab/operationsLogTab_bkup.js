...
import {
    ...
    setReportsSpinner,
    flushWSData
} from '../../actions/operationsLogsActions';

import {
    WS_ONSEND, POST, OPERATION_LOG_FETCH
    , APP_JSON, OPERATIONS_LOG_MODE_MAP,
    DEFAULT_PAGE_SIZE_OL, REALTIME, DOWNLOAD_REPORT_REQUEST, REPORT_NAME_OPERATOR_LOGS
...
import {
    OPERATIONS_LOG_URL,
    WS_OPERATIONS_LOG_SUBSCRIPTION,
...
const pageSizeDDOpt = [{
    value: "25", disabled: false, label: <FormattedMessage id="operationLog.page.twentyfive" description="Page size 25"
                                                           defaultMessage="25"/>
},
    {
    ...
    },
    {
        value: "100",
        disabled: false,
        label: <FormattedMessage id="operationLog.page.hundred" description="Page size 100"
                                 defaultMessage="100"/>
    }];
/*Intl Messages*/
            ...
            <div className="gorTesting wrapper gor-operations-log">
                    ...
                    <div className="filterWrapper">
                        ...
                        <div className="gorToolBarDropDown">
                            <div className="gor-button-wrap">
                                <button disabled={pageSizeDDDisabled}
                ...
                <div className="gor-ol-paginate-wrap">
                    ...
                    <div className="gor-ol-paginate-right">
                        <GorPaginateV2 disabled={pageSizeDDDisabled} location={location}
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        applyOLFilterFlag: function (data) {
            dispatch(applyOLFilterFlag(data))
        },
        wsOLUnSubscribe: function (data) {
            dispatch(wsOLUnSubscribe(data))
        },
        wsOLSubscribe: function (data) {
            dispatch(wsOLSubscribe(data))
        },
        setReportsSpinner: function (data) {
            dispatch(setReportsSpinner(data))
        }
    }
};
...
export default compose(withQuery)(connect(mapStateToProps, mapDispatchToProps)(Dimensions()(withRouter(injectIntl(OperationsLogTab)))))
