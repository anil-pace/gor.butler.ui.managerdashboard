...
class SlotsTable extends React.Component {
  constructor(props) {
    ...
    this.state = {
      header: [
        { id: 0, text: 'SLOT TYPE', key: 'slot_type', sortable: false },
        ...
        <GTable>
          <GTableHeader>
            <GTableHeaderCell header={self.state.header[0]}>
              <span>
                <FormattedMessage
                  id='slot.table.slotType'
                  description='Slot Type column'
            ...
            <GTableHeaderCell header={self.state.header[1]}>
              <span>
                <FormattedMessage
                  id='slot.table.slotVolume'
                  description='SlotVolume'
            ...
            <GTableHeaderCell header={self.state.header[2]}>
              <span>
                <FormattedMessage
                  id='slot.table.dimension'
                  description='DIMENSION(L*B*H)'
          ...
          <GTableBody data={self.state.slotList}>
            {self.state.slotList &&
              self.state.slotList.map(function(row, idx) {
                return (
