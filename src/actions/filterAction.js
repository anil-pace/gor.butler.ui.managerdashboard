import {
  ...
  IS_FILTER_APPLIED,
  BUTLER_FILTER_STATE,
  CHARGINGSTATION_FILTER_STATE,
  PPS_FILTER_STATE,
  WAVE_FILTER_STATE,
  USER_FILTER_STATE,
  TOGGLE_BUTTON_BOT,
  PPS_FILTER_VALUE,
  CHARGING_FILTER_VALUE,
  WAVE_FILTER_VALUE,
  USER_FILTER_VALUE,
  AUDIT_FILTER_STATE,
  AUDIT_FILTER_VALUE,
  ...
  CS_TOGGLE_FILTER,
  WAVES_TOGGLE_FILTER,
  ORDERS_TOGGLE_FILTER,
  AUDIT_TOGGLE_FILTER,
  USER_TOGGLE_FILTER,
  FILTER_APPLY_FLAG,
  MSU_CONFIG_FILTER_STATE
...
//This action is use to keep the current filter state for Item Search tab
export function itemSearchfilterState(data) {
  return {
    type: ITEM_SEARCH_FILTER_STATE,
    data
  };
}
