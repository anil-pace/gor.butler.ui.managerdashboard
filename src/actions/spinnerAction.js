...
DISPLAY_PPS_FILTER_SPINNER,DISPLAY_BOT_FILTER_SPINNER,DISPLAY_WAVES_FILTER_SPINNER,DISPLAY_INVENTORY_REPORT_SPINNER,GENERATE_REPORT_SPINNER} from '../constants/frontEndConstants';
...
export function setGenerateReportSpinner(data){
	return {
		type: GENERATE_REPORT_SPINNER,
		data
	}
}