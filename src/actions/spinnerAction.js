...
import { DISPLAY_SPINNER,DISPLAY_WAVES_SPINNER,DISPLAY_BUTLER_SPINNER,DISPLAY_PPS_SPINNER, DISPLAY_MSU_SPINNER,
...
DISPLAY_PPS_FILTER_SPINNER,DISPLAY_BOT_FILTER_SPINNER,DISPLAY_WAVES_FILTER_SPINNER,DISPLAY_INVENTORY_REPORT_SPINNER,DISPLAY_STOCK_LEDGER_SPINNER,DISPLAY_STOCK_LEDGER_RAW_TRANSACTIONS_SPINNER} from '../constants/frontEndConstants';
...
export function setMsuSpinner(data){
	return{
		type: DISPLAY_MSU_SPINNER,
		data
	}
}
